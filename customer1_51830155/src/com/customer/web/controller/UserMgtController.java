...
public class UserMgtController {
 ...
 //@PostConstruct
	public void init() {
		userService.addUser(new User("mahi", "mahi@mahi.com", "mahi123", "admin",true));
				
		userService.addUser(new User("babi", "babi@babi.com", "babi123", "mgr",true));
				
		userService.addUser(new User("vijay", "vijay@vijay.com", "vijay123","emp",true));
